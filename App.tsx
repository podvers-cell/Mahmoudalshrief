      ...
      <section className="relative min-h-[85vh] sm:min-h-[90vh] md:min-h-[95vh] flex items-center pt-16 sm:pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 w-full">
          ...
          >
            ...
            <h1 className={`text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-900'} leading-[0.9] mb-6 sm:mb-8 tracking-tight px-2`}>
              Cinematic <br className="hidden sm:block" />
